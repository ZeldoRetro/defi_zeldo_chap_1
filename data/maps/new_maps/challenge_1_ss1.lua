...
--PORTES TROLL
function sensor_troll_door_open_1:on_activated()
  local movement = sol.movement.create("straight")
  movement:set_angle(math.pi)
  movement:set_speed(88)
  movement:set_max_distance(56)

  map:set_doors_open("troll_door_1")
  hero:freeze()
  hero:set_direction(2)
  hero:set_animation("walking")
  movement:start(hero, function() hero:unfreeze() end)
end
function sensor_troll_door_open_2:on_activated()
  local movement = sol.movement.create("straight")
  movement:set_angle(0)
  movement:set_speed(88)
  movement:set_max_distance(56)

  map:set_doors_open("troll_door_2")
  hero:freeze()
  hero:set_direction(0)
  hero:set_animation("walking")
  movement:start(hero, function() hero:unfreeze() end)
end
function sensor_troll_door_open_3:on_activated()
  local movement = sol.movement.create("straight")
  movement:set_angle(0)
  movement:set_speed(88)
  movement:set_max_distance(56)

  map:set_doors_open("troll_door_3")
  hero:freeze()
  hero:set_direction(0)
  hero:set_animation("walking")
  movement:start(hero, function() hero:unfreeze() end)
...
function sensor_troll_door_open_8:on_activated()
  local movement = sol.movement.create("straight")
  movement:set_angle(0)
  movement:set_speed(88)
  movement:set_max_distance(56)

  map:set_doors_open("troll_door_8")
  hero:freeze()
  hero:set_direction(0)
  hero:set_animation("walking")
  movement:start(hero, function() hero:unfreeze() end)
end
function sensor_troll_door_open_9:on_activated()
  local movement = sol.movement.create("straight")
  movement:set_angle(math.pi / 2)
  movement:set_speed(88)
  movement:set_max_distance(56)

  map:set_doors_open("troll_door_9")
  hero:freeze()
